    ...
    <!-- Inicio do formulario -->
      <form method="post" action="{{route('criar')}}">
        ...
        <label>Nome:
            ...
            <label>Telefone:
            <input name="telefone" type="text" id="telefone" size="40" /></label><br />
            <label>Email:
        ...
        <label>Barrio:
        <input name="barrio" type="text" id="barrio" size="40" /></label><br />
        <label>Cidade:
        ...
        <label>Complemento:
        <input name="complemento" type="text" id="complemento" size="8" /></label><br />
        <label>Pais:
        <input name="pais" type="text" id="pais" size="8" /></label><br />
        <label>IBGE:
